...
import 'package:plant_app/vision_detector/detector_view.dart';

import '../path/path.dart';
import '../util/object_detector_painter.dart';
...
class _ObjectDetectorView extends State<ObjectDetectorView> {
  ...
  void _initializeDetector() async {
    ...
    if (_option == 0) {
      ...
      final modelPath = await getAssetPath('assets/models/$option');
