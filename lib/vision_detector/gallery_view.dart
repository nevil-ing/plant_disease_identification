  ...
  Widget _galleryBody() {
       ...
       Padding(
        ...
        borderRadius: BorderRadius.circular(20.0),
           ...
           child: ListTile(
                 ...
                 subtitle: const Text('from your gallery', style: TextStyle(color: Colors.green)),
    ...
    Padding(
      ...
      child: Card(
        ...
        child: ListTile(
          title: const Text('Take a picture', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
          subtitle: const Text('of your plant', style: TextStyle(color: Colors.green)),
    ...
    Padding(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          subtitle: const Text('of your plants', style: TextStyle(color: Colors.green)),
